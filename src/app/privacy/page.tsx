...
const sections = [
  ["Information collected", "North Allen Perfumery collects information needed to operate the shop, including name, email address, optional phone number, account details, order details, selected fragrance notes, special instructions, payment status, and customer messages."],
  ["How information is used", "Information is used to provide accounts, process orders, create custom scents, send order and status emails, provide opted-in order status calls, respond to inquiries, prevent fraud, improve the website, and comply with legal obligations."],
  ...
  ["Phone calls", "North Allen Perfumery uses Twilio for the automated phone receptionist and transactional order status calls. Order status calls are only sent to customers who provide a phone number and opt in during checkout."],
